...
def mechant_niveau1():
    global position, position_mechant_niveau1_1, arc_attaque_mechant1, rotation, attaque_mechant1_1, decompte_attaque_mechant1_1, attaque_mechant1_1_droite, position_arc_attaque_niveau1_1, nbr_vie, avancement_niveau
    ...
    if attaque_mechant1_1 == False:
        if (-100 < deplacement_mechant_niveau1_1_x < 100) and (-100 < deplacement_mechant_niveau1_1_y < 100):
            if deplacement_mechant_niveau1_1_x < 0:
                ...
                pygame.mixer.music.load(chemin_repertoire + "\contenu\son\\attaque_mechant1.mp3")
                pygame.mixer.music.play(1)
                nbr_vie -= 1
