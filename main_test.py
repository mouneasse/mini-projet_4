...
def drawFenetre():
    global anim_cooldown, tempsInitial, change_fond, fond, texte_tapis_rouge, nbr_fond, nbr_e
...
class joueur(object):
    ...
    def mouvement(self,touche):
        global nbr_fond, change_fond, count_e
        if touche[pygame.K_e] and count_e <= 0 and (self.x_j <= 255 and 230 <= self.y_j <= 465):
            nbr_fond +=1
            change_fond = True
            print(nbr_fond)
            self.x_j = 1200
